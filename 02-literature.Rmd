...
exclusion [@currie2010modeling]. Both of these research studies showed the
...
vulnerable social groups. @grengs2015nonwork found that when looking at
...
important to all [@barclay2017space]
...
stronger correlation between parks and physical activity [@bancroft2015association].
...
grocery stores had a corresponding diet with fewer fruits and vegetables [@aggarwal2014access].
...
the time budget [@widener2015spatiotemporal]. In another study done in China,
@chen2021effects used three different space-time accessibility measures to
  determine how
...
hypothesis the most likely option for each individual [@dong2006moving]. Using
...
difficult to interpret [@handy1997measuring]
...
successful in research done in Alameda County, California [@macfarlane2020modeling].  We can rely on large-scale passive origin-destination data sets to
