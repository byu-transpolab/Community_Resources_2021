...
predominately suburban built environments. 

Table \@ref(tab:acstable) presents descriptive statistics of the block groups
in Utah County obtained from the 2015-2019 American Community Survey (ACS) using
the tidycensus package for R [@tidycensus].
...
if(knitr::is_html_output()){
  ...
  pnts  <- mapdata %>% st_transform(4326) %>% filter(!st_is(., "MULTIPOLYGON"))
