...
```{r utco-map, fig.cap="Location of community resources in Utah County", fig.align='center', dev='tikz', cache = FALSE, fig.width=6, fig.height=6,dev.args=list(pointsize=2)}
tar_load(groceries)
