...
```{r access-map, dev = "tikz", dev.args=list(pointsize=12), fig.cap = "Spatial comparison of grocery access threshold versus logsum value."}
amdata <- bind_rows(
...
```{r access-plot, fig.cap="Relationship between travel time and logsum access value for block groups in Utah County. Travel time thresholds shown as dashed lines, with best fit regresssion line added for context.", fig.height=4, dev = "tikz", dev.args=list(pointsize=10)}
